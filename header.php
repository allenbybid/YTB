	...
	<div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
		...
		<div id="custom-search-input">
			...
			<div class="input-group col-md-12">
				...
				<input type="text" name="q"  class="search-query form-control" id="youtube" placeholder="搜索"><span class="input-group-btn"><button class="btn btn-danger" type="submit" style="z-index:4"><span class="fa d-inline fa-search"></span></button></span>
				</div>
			</form>
		<script >
