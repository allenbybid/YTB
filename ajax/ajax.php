...
ini_set('error_log', dirname(__FILE__) . '/error_log.txt');  
    ...
    case 'menu':
        ...
        <li class="list-group-item font-weight-bold"></i>YTB 精选</li>
        ';
...
echo '<h6 class="pt-3"><b>用户须知：</b><h6>';
  ...
  <input name="type" value="videodownload" style="display: none;">
      <input type="text" name="link"  placeholder="请输入YTB视频链接" id="soinpt"  autocomplete="off" /><button type="submit" id="subu" style="width: 24%;vertical-align:middle;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;" ><i class="fa fa-download fa-lg pr-1"></i>下载</button>
  </div>
    </form>';
